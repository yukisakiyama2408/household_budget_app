  ...
  return (
    <section className="rounded-lg border bg-white p-4">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h2 className="text-sm font-bold text-gray-900">予算見直し</h2>
      ...
      <div className="mt-3 rounded-md bg-gray-50 px-3 py-2 text-xs leading-5 text-gray-500">
        CSVをChatGPTにアップロードして、コピーしたプロンプトを貼り付けます。出力された予算案は下の一括登録に貼り付けて反映できます。
      </div>
    </section>
  );
}
