...
回答は必ず以下のフォーマットで出力してください。金額はCSVの実績を根拠に、具体的な数値で記載してください。
...
| カテゴリ | 実績 | 評価 | 増減の要因 |
|---|---:|---|---|
| 食費 | ¥___,___ | 維持／削減／増額 | ___ |

【予算設定への引き継ぎ】
| カテゴリ | 今月実績 | 来月の推奨予算 | 調整額 | 根拠 |
|---|---:|---:|---:|---|
| 食費 | ¥___,___ | ¥___,___ | ¥___,___ | ___ |
...
【カテゴリ別評価】
| カテゴリ | 先週実績 | 今週実績 | 週次予算 | 評価・要因 |
|---|---:|---:|---:|---|
| 食費 | ¥___,___ | ¥___,___ | ¥___,___ | ___ |

【予算設定への引き継ぎ】
| カテゴリ | 今週実績 | 次週の推奨予算 | 調整額 | 根拠 |
|---|---:|---:|---:|---|
| 食費 | ¥___,___ | ¥___,___ | ¥___,___ | ___ |
...
【カテゴリ別評価】
| カテゴリ | 年間実績 | 月平均 | 評価 | 改善余地 |
|---|---:|---:|---|---|
| 食費 | ¥___,___ | ¥___,___ | 維持／削減／増額 | ___ |

【翌年予算への引き継ぎ】
| カテゴリ | 当年実績 | 翌年の年間予算 | 翌年の月平均予算 | 根拠 |
|---|---:|---:|---:|---|
| 食費 | ¥___,___ | ¥___,___ | ¥___,___ | ___ |
