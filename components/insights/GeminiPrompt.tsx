...
特に、繰り返しているムダな支出や、削減しやすそうな項目を具体的に指摘してください。`,
  },
  {
    id: "savings",
    label: "貯金目標設定",
    text: `添付の家計簿データを元に、現実的な貯金目標を設定するアドバイスをください。

以下の形式で回答してください：
1. 現在の収支バランスから算出できる月間最大貯蓄可能額
2. 短期目標（3ヶ月・6ヶ月・1年）の貯金目標額の提案
3. 目標達成のために削減すべき具体的な支出カテゴリと金額
4. 達成しやすい期限付き目標を1つ（例：○年○月までに○万円）`,
  },
  {
    id: "weekly",
    label: "週次分析",
