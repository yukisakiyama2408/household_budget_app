...
4. 今週意識すべきポイント`,
  },
  {
    id: "next_week_budget",
    label: "翌週予算設定",
    text: `添付の家計簿CSVを元に、来週の予算を設定してください。
CSVの末尾に「# 貯金目標の進捗」セクションが含まれている場合は、その達成状況も踏まえて予算を調整してください。

まず直近4週間の週平均支出を分析し、貯金目標の達成状況を踏まえた上で、来週の推奨予算を以下の形式で出力してください（アプリへそのまま入力できるよう金額を明記してください）：
...
最後に、特に注意すべきカテゴリと貯金目標の進捗に対する一言アドバイスをください。`,
  },
  {
...
まず直近3ヶ月の月平均支出を分析し、貯金目標の達成状況を踏まえた上で、来月の推奨予算を以下の形式で出力してください（アプリへそのまま入力できるよう金額を明記してください）：
